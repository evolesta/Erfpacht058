...
namespace Erfpacht058_API.Migrations
{
    ...
    [Migration("20240322125646_EditOvereenkomstNullableFields")]
    partial class EditOvereenkomstNullableFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Erfpacht058_API.Models.Gebruiker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = 1,
                            Voornamen = "Eerste",
                            Wachtwoord = "$2a$11$ApMMa.vvGc6.u1mjrD1mYuibT2bL3HgztS1hLhYrcKVT13BJjOL3W"
                        });
                });
