...
namespace Erfpacht058_API.Migrations
{
    ...
    [Migration("20240311101731_EditEigenaarNullableFields")]
    partial class EditEigenaarNullableFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Erfpacht058_API.Models.Gebruiker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = 1,
                            Voornamen = "Eerste",
                            Wachtwoord = "$2a$11$kOE.FcxI00N2lAvFHx0Am.cnH6XS5CxQ8A8RE9Bu8ayUblliRe1N."
                        });
                });
