...
namespace Erfpacht058_API.Migrations
{
    ...
    [Migration("20240726074320_EditKadasterStructure")]
    partial class EditKadasterStructure
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Erfpacht058_API.Models.Eigendom.Kadaster", b =>
                {
                    ...
                    b.Property<float>("Bouwjaar")
                        .HasColumnType("real");

                    b.Property<int?>("EigendomId")
                        .HasColumnType("int");

                    b.Property<string>("Gebruiksdoel")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Erfpacht058_API.Models.Gebruiker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = 1,
                            Voornamen = "Eerste",
                            Wachtwoord = "$2a$11$Uc5.4aivaWigaWNIFNC7ceQmgjlxu1kXf71Rf3CRiVBlgh.ZTKcaq"
                        });
                });
