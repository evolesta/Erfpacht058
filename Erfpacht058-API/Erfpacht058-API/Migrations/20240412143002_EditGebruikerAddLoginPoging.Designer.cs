...
namespace Erfpacht058_API.Migrations
{
    ...
    [Migration("20240412143002_EditGebruikerAddLoginPoging")]
    partial class EditGebruikerAddLoginPoging
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Erfpacht058_API.Models.Gebruiker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = 1,
                            Voornamen = "Eerste",
                            Wachtwoord = "$2a$11$Z8YcmKs6xz3hPbHRTNDVUOq60htPap6TAi1syz8FWGf1sUr4CIREK"
                        });
                });
