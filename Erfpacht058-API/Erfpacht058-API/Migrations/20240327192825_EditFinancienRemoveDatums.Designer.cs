...
namespace Erfpacht058_API.Migrations
{
    ...
    [Migration("20240327192825_EditFinancienRemoveDatums")]
    partial class EditFinancienRemoveDatums
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Erfpacht058_API.Models.Gebruiker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = 1,
                            Voornamen = "Eerste",
                            Wachtwoord = "$2a$11$6DkF7BUijzRSiPxvKgDQ2uy9EAUNeheheP68uMSnH6zx6d.3hFDiy"
                        });
                });
